 ...
 ?>
	...
	<div class="col-md-6">
		<?php if( $konfigurasi->logo != "" ) { ?>
			<img src="<?php echo base_url('assets/upload/img/'.$konfigurasi->logo )  ?>" alt="<?php echo $konfigurasi->nama_web ?>" class="img img-responsive img-thumbnail">
		<?php }else{ ?>
			<p class="alert alert-danger text-center">Belum ada Logo !</p>
		<?php } ?>
	</div>
